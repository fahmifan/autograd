import { Anchor, Flex, Loader, Pagination, Table, Text, Tooltip } from "@mantine/core";
import { IconExternalLink } from "@tabler/icons-react";
import { useState } from "react";
import { useQuery } from "react-query";
import { Link, useSearchParams } from "react-router-dom"
import { Breadcrumbs } from "../../../../components/Breadcrumbs"
import { FindAllCourseStudentsResponse, PaginationRequest } from "../../../../pb/autograd/v1/autograd_pb";
...
function useCourseStudents(arg: {
    ...
    const queryKeys = ["courses", arg.courseID, "students", "page", arg.page, "limit", arg.limit]
...
export function PageStudents() {
    ...
    const items = [
        ...
        { title: hookCourse.res?.course?.name ?? "", to: `/backoffice/courses/detail?courseID=${courseID}` },
		{ title: "Students", to: `/backoffice/courses/students?courseID=${courseID}` },
	]
        ...
        <Table striped highlightOnHover maw={800} mb="lg">
            ...
            <Table.Tbody>
            {
                ...
                : hookCourseStudents.res?.students?.map(student => {
                    return <Table.Tr key={student.id}>
                        <Table.Td>
