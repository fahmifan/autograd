...
import { CreateManagedUser, ListManagedUsers, actionCreateManagedUser, loaderUserManagement } from './UserManagement';
...
export default function DashboardLayout() {
	...
	return (
		<AppShell
			...
			>
			<AppShell.Header>
				<Text py="sm" px="sm" size="lg">Autograd Dashboard</Text>
			</AppShell.Header>
